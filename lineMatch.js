...
export function matchSegment(ax, ay, bx, by, cx, cy, dx, dy, r, result) {
...
export function addSegment(arr, ax, ay, bx, by) {
    arr.push(ax);
    arr.push(ay);
    arr.push(bx);
    arr.push(by);
...
export function closePoint(px, py, ax, ay, bx, by, r) {
...
export function equals(ax, ay, bx, by) {
